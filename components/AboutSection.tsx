export default function AboutSection() {
  return (
    <section id="about" className="py-32 px-6 bg-[#0a0c14]">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="glass-morphism cyber-border p-10 rounded-sm border-l-blue-500/50">
            <h3 className="text-2xl font-black mb-8 text-white uppercase tracking-tight flex items-center gap-4">
              <span className="text-blue-500">02.</span> UTILIZAÇÃO RESPONSÁVEL
            </h3>
